...
public class ErrorTest01Working {
	...
	public void test01() throws Exception {
		...
		if (Flag.flag) {
			/*
			 * '400 Bad Request: [{"status":"fail","message":"terminalName is missing"}\n]
			 */
			String pattern = null;
			String str = "400 Bad Request: [{\"status\":\"fail\",\"message\":\"terminalName is missing\"}\n]";
			pattern = ".*terminalName\\b.*\\R.*";
			//pattern = "400.*";
