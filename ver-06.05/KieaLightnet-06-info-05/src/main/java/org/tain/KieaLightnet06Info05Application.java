...
@EnableScheduling
@Slf4j
public class KieaLightnet06Info05Application implements CommandLineRunner {

	public static void main(String[] args) {
		log.info("KANG-20200721 >>>>> {} {}", CurrentInfo.get(), LocalDateTime.now());
		SpringApplication.run(KieaLightnet06Info05Application.class, args);
	}
	...
	private void job01() throws Exception {
		...
		if (Flag.flag) {
			...
			JsonPrint.getInstance().printPrettyJson(this.lnsEnvInfoProperties);
