...
@RestController
@RequestMapping(value = {"/info/properties"})
@Slf4j
public class PropertiesController {
	...
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18087/v0.3/info/properties/base
	...
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18087/v0.3/info/properties/json
	...
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18087/v0.3/info/properties/info

	@Autowired
	private LnsEnvInfoProperties lnsEnvInfoProperties;
	...
	public ResponseEntity<?> virtual(HttpEntity<String> httpEntity) throws Exception {
		...
		if (Flag.flag) {
			log.info("--------------- v1 Response --------------------");
			log.info(">>>>> Headers = " + headers);
			log.info(">>>>> Body = " + this.lnsEnvInfoProperties);
			log.info("==================================================");
		}
		
		return new ResponseEntity<>(this.lnsEnvInfoProperties, headers, HttpStatus.OK);
	}
}
