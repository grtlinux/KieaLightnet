...
@Slf4j
public class ListV11Controller {
	
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18888/v1.1/remittances?operatorCode&offset=0&limit=20
	/*
	...
	public ResponseEntity<?> list(HttpEntity<String> httpEntity) throws Exception {
		...
		if (Flag.flag) {
			map = new ObjectMapper().readValue(
					new File(System.getenv("HOME") + this.lnsEnvVirtualProperties.getList1File())
