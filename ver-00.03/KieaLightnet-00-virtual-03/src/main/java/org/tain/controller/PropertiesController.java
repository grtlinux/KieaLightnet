...
@RestController
@RequestMapping(value = {"/virtual/properties"})
@Slf4j
public class PropertiesController {
	...
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18888/virtual/properties/base
	...
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18888/virtual/properties/json
	...
	public ResponseEntity<?> virtual(HttpEntity<String> httpEntity) throws Exception {
		...
		if (Flag.flag) {
			log.info("--------------- v1 Response --------------------");
			log.info(">>>>> Headers = " + headers);
			log.info(">>>>> Body = " + this.lnsEnvVirtualProperties);
			log.info("==================================================");
		}
		
		return new ResponseEntity<>(this.lnsEnvVirtualProperties, headers, HttpStatus.OK);
	}
}
