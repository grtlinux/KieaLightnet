...
@Controller
@RequestMapping(value = {"/apis/amend"})
@Slf4j
public class AmendRestController {
	...
	public ResponseEntity<?> mapperReqJson2Str(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Amend mapperReqJson2Str");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/amend/req/j2s");
	...
	public ResponseEntity<?> amend(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			lnsJson.setHttpUrl("http://localhost:18091/v1.0/lns01/amend");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperResStr2Json(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Amend mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/amend/res/s2j");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Amend mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/amend/req/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
	...
	public ResponseEntity<?> mapperResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Amend mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/amend/res/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
