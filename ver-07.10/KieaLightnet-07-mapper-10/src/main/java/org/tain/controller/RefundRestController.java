...
import org.tain.object.refund.res._ResRefundData;
...
@RestController
@RequestMapping(value = {"/mapper/refund"})
@Slf4j
public class RefundRestController {
	...
	/*
	 * http://localhost:18086/v1.0/mapper/refund/req/s2j
	 */
	@RequestMapping(value = {"/req/s2j"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> refundReqStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
	...
	/*
	 * http://localhost:18086/v1.0/mapper/refund/res/s2j
	 */
	@RequestMapping(value = {"/res/s2j"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> refundResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			_ResRefundData resData = new _ResRefundData();
			resData = (_ResRefundData) TransferStrAndJson.getObject(resData);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/refund/req/j2s
	 */
	@RequestMapping(value = {"/req/j2s"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> refundReqJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			_ReqRefundData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqRefundData.class);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/refund/res/j2s
	 */
	@RequestMapping(value = {"/res/j2s"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> refundResJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			_ResRefundData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResRefundData.class);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/refund/req/cstruct
	 */
	...
	public ResponseEntity<?> detailReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			//_ReqRefundData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqRefundData.class);
			String reqCStruct = TransferStrAndJson.getCStruct(new _ReqRefundData());
	...
	/*
	 * http://localhost:18086/v1.0/mapper/refund/res/cstruct
	 */
	@RequestMapping(value = {"/res/cstruct"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> refundResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			//_ResRefundData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResRefundData.class);
			String resCStruct = TransferStrAndJson.getCStruct(new _ResRefundData());
