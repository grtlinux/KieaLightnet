...
import org.tain.object.commit.res._ResCommitData;
...
public class CommitRestController {
	...
	/*
	 * http://localhost:18086/v1.0/mapper/commit/req/s2j
	 */
	...
	/*
	 * http://localhost:18086/v1.0/mapper/commit/res/s2j
	 */
	...
	public ResponseEntity<?> commitResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResCommitData resData = new _ResCommitData();
			resData = (_ResCommitData) TransferStrAndJson.getObject(resData);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/commit/req/j2s
	 */
	...
	/*
	 * http://localhost:18086/v1.0/mapper/commit/res/j2s
	 */
	...
	/*
	 * http://localhost:18086/v1.0/mapper/commit/req/cstruct
	 */
	...
	public ResponseEntity<?> detailReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			//_ReqCommitData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqCommitData.class);
			String reqCStruct = TransferStrAndJson.getCStruct(new _ReqCommitData());
	...
	/*
	 * http://localhost:18086/v1.0/mapper/commit/res/cstruct
	 */
	...
	public ResponseEntity<?> commitResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			//_ResCommitData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResCommitData.class);
			String resCStruct = TransferStrAndJson.getCStruct(new _ResCommitData());
