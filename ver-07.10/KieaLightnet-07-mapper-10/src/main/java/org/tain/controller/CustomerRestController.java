...
import org.tain.object.customer.res._ResCustomerData;
...
@RestController
@RequestMapping(value = {"/mapper/customer"})
@Slf4j
public class CustomerRestController {
	...
	/*
	 * http://localhost:18086/v1.0/mapper/customer/req/s2j
	 */
	@RequestMapping(value = {"/req/s2j"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> customerReqStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
	...
	/*
	 * http://localhost:18086/v1.0/mapper/customer/res/s2j
	 */
	@RequestMapping(value = {"/res/s2j"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> customerResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			_ResCustomerData resData = new _ResCustomerData();
			resData = (_ResCustomerData) TransferStrAndJson.getObject(resData);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/customer/req/j2s
	 */
	@RequestMapping(value = {"/req/j2s"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> customerReqJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			_ReqCustomerData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqCustomerData.class);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/customer/res/j2s
	 */
	@RequestMapping(value = {"/res/j2s"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> customerResJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			_ResCustomerData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResCustomerData.class);
	...
	/*
	 * http://localhost:18086/v1.0/mapper/customer/req/cstruct
	 */
	...
	public ResponseEntity<?> detailReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			//_ReqCustomerData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqCustomerData.class);
			String reqCStruct = TransferStrAndJson.getCStruct(new _ReqCustomerData());
	...
	/*
	 * http://localhost:18086/v1.0/mapper/customer/res/cstruct
	 */
	@RequestMapping(value = {"/res/cstruct"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> customerResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200623 >>>>> {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			...
			//_ResCustomerData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResCustomerData.class);
			String resCStruct = TransferStrAndJson.getCStruct(new _ResCustomerData());
