...
@EnableScheduling
@Slf4j
public class KieaLightnet02Link03Application implements CommandLineRunner {

	public static void main(String[] args) {
		log.info("KANG-20200721 >>>>> {} {}", CurrentInfo.get(), LocalDateTime.now());
		SpringApplication.run(KieaLightnet02Link03Application.class, args);
	}
	...
	private void job01() throws Exception {
		...
		if (Flag.flag) {
			...
			log.info("KANG-20200721 >>>>> {} {}", CurrentInfo.get(), this.lnsEnvLinkProperties);
		}
