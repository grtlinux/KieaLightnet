...
public class DetailController {
	...
	///////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////
	// http://localhost:18082/v0.3/link/detail
	...
	public ResponseEntity<?> detail(HttpEntity<String> _httpEntity) {
		...
		if (Flag.flag) {
			try {
				...
				accessToken = this.accessToken.getAccessToken("/detail");
		...
		if (Flag.flag) {
			try {
				...
				UriComponents builder = UriComponentsBuilder.fromHttpUrl(this.lnsEnvLinkProperties.getLightnetUrl() + GET_DETAIL_HTTPS_URL)
						.queryParams(reqMap)
						.build(true);
