...
import org.tain.properties.LnsEnvMapperProperties;
...
@EnableScheduling
@Slf4j
public class KieaLightnet07Mapper03Application implements CommandLineRunner {

	public static void main(String[] args) {
		log.info("KANG-20200721 >>>>> {} {}", CurrentInfo.get(), LocalDateTime.now());
		SpringApplication.run(KieaLightnet07Mapper03Application.class, args);
	}
	...
	@Autowired
	private LnsEnvMapperProperties lnsEnvMapperProperties;
	...
	private void job01() throws Exception {
		...
		if (Flag.flag) {
			...
			log.info(">>>>> mapper.jsonString: " + this.lnsEnvMapperProperties.toPrettyJson());
		}
